...
export default function Home() {
  ...
  return (
    <div>
      {/* Add more margin to create more space from the navbar */}
      <div className="mt-32"> {/* Adjusted to mt-32 for more space */}
        {/* Summer Styles Section */}
        ...
        <div className="bg-gray-100 py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 className="text-2xl font-bold text-center text-gray-900">Our Achievements</h2>
            <dl className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.name} className="flex flex-col items-center">
                  ...
                  <dd className="text-sm font-semibold text-gray-600">{stat.name}</dd>
                </div>
              ))}
            </dl>
          </div>
